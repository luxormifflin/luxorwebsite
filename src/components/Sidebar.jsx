    ...
    return (
        <nav className='hidden lg:flex lg:w-72 border border-gray-300 h-full flex-col bg-gray-200 p-4 sidebar'>
            ...
            <div className='my-4'>
                ...
                <Ruta icono='fas fa-paperclip' ruta='/admin/productos' nombre='Productos' />
...
const Ruta = ({ icono, ruta, nombre, usuario }) => {
    ...
    return (
        <Link to={ruta}>
            <button
                className={`p-1 my-2  bg-${isActive ? 'green' : 'gray'
                    }-700 hover:bg-green-300 flex w-full items-center text-white rounded-md`}
            >
                {usuario ? (
                    <>
